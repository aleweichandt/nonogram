...
import {
  StateType, StateWithGameType, BoardType,
} from './types';
...
export const createColInfo = () => createSelector(
  [getBoard, getProgress, propsSelector],
